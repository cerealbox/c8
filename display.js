...
function displayo(gs) {
	...
	discard.reverse()
	discard.forEach((card, i) => document.getElementById(card).className = "discard_" + i)

	deck.reverse()
	deck.forEach((card, i) => document.getElementById(card).className = "deck_" + i)

	player0.reverse()
	player0.forEach((card, i) => document.getElementById(card).className = "player0_" + i)

	player1.reverse()
	player1.forEach((card, i) => document.getElementById(card).className = "player1_" + i)	
...
for (var suit = 1; suit <= 4; suit++) {
	...
	"seven", "eight", "nine", "ten", "jack", "queen", "king"].forEach(face => {
		document.write(`
			<img 
