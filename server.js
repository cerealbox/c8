...
(function(exports) {
  ...
  var Game = PS["Game"];        
  var Client = (function () {
      function Client(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Client.create = function (value0) {
          return function (value1) {
              return new Client(value0, value1);
          };
      };
      return Client;
  })();
  var Connection = (function () {
      function Connection(value0) {
          this.value0 = value0;
      };
      Connection.create = function (value0) {
          return new Connection(value0);
      };
      return Connection;
  })();
  var ClientMessage = (function () {
      function ClientMessage(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ClientMessage.create = function (value0) {
          return function (value1) {
              return new ClientMessage(value0, value1);
          };
      };
  ...
  exports["listenStatic"] = $foreign.listenStatic;
  exports["sendToAll"] = $foreign.sendToAll;
  ...
  var gameLoop = function (v) {
      if (v.done) {
          return function __do() {
              ...
              Data_Function.apply(WS.sendToAll)(Data_Argonaut_Encode_Class.gEncodeJson(Game.genericGamestate)(v1))();
              return gameLoop(v1)();
          };
      };
      return function __do() {
          var v1 = WS.getEvent();
          if (v1 instanceof WS.Connection && v1.value0 instanceof WS.Client) {
              Data_Function.apply(Control_Monad_Eff_Console.log)("connect: " + (v1.value0.value0 + (":" + Data_Show.show(Data_Show.showInt)(v1.value0.value1))))();
              var v2 = Data_Function.apply(Game.update(v))(Data_Function.apply(Game.AddPlayer.create)(v1.value0.value0 + (":" + Data_Show.show(Data_Show.showInt)(v1.value0.value1))))();
              Data_Function.apply(WS.sendToAll)(Data_Argonaut_Encode_Class.gEncodeJson(Game.genericGamestate)(v2))();
              return Data_Function.apply(WS.waitForEvent)(gameLoop(v2))();
          };
          if (v1 instanceof WS.ClientMessage && v1.value0 instanceof WS.Client) {
              Data_Function.apply(Control_Monad_Eff_Console.log)(v1.value0.value0 + (Data_Show.show(Data_Show.showInt)(v1.value0.value1) + (": " + Data_Show.show(Data_Argonaut_Core.showJson)(v1.value1))))();
              if (v.players instanceof Data_List.Cons && v.players.value0.ipport === v1.value0.value0 + (":" + Data_Show.show(Data_Show.showInt)(v1.value0.value1))) {
                  var v2 = Data_Function.apply(Game.update(v))(Game.ai(v))();
                  Data_Function.apply(WS.sendToAll)(Data_Argonaut_Encode_Class.gEncodeJson(Game.genericGamestate)(v2))();
                  return Data_Function.apply(WS.waitForEvent)(gameLoop(v2))();
              };
              return Data_Function.apply(WS.waitForEvent)(gameLoop(v))();
          };
          if (v1 instanceof WS.Close && v1.value0 instanceof WS.Client) {
              Data_Function.apply(Control_Monad_Eff_Console.log)("close: " + (v1.value0.value0 + (":" + Data_Show.show(Data_Show.showInt)(v1.value0.value1))))();
              var v2 = Data_Function.apply(Game.update(v))(Data_Function.apply(Game.RemovePlayer.create)(v1.value0.value0 + (":" + Data_Show.show(Data_Show.showInt)(v1.value0.value1))))();
              Data_Function.apply(WS.sendToAll)(Data_Argonaut_Encode_Class.gEncodeJson(Game.genericGamestate)(v2))();
              return Data_Function.apply(WS.waitForEvent)(gameLoop(v2))();
          };
          if (v1 instanceof WS.Tick) {
              if (v.players instanceof Data_List.Cons && v.players.value0.ai) {
                  Data_Function.apply(Control_Monad_Eff_Console.log)(Game.showPlay(v)(Game.ai(v)))();
                  var v2 = Data_Function.apply(Game.update(v))(Game.ai(v))();
                  Data_Function.apply(Control_Monad_Eff_Console.log)(Data_Show.show(Game.gameStateShow)(v2))();
                  Data_Function.apply(WS.sendToAll)(Data_Argonaut_Encode_Class.gEncodeJson(Game.genericGamestate)(v2))();
                  return Data_Function.apply(WS.waitForEvent)(gameLoop(v2))();
              };
              return Data_Function.apply(WS.waitForEvent)(gameLoop(v))();
          };
          return Partial_Unsafe.unsafeCrashWith("failure.")();
      };
  };
  var main = function __do() {
      var v = Game.shuffle(Game.allCards)();
      Data_Function.apply(Control_Monad_Eff_Console.log)(Data_Function.apply(Game.showHand(Game.cardShow))(Data_List.sort(Game.ordCard)(v)))();
      Control_Monad_Eff_Console.log("\n")();
      WS.listenStatic("200.200.200.5")(88)();
      WS.listen("200.200.200.5")(888)();
      return Data_Function.apply(WS.waitForEvent)(gameLoop(Game.emptyGameState))();
  };
